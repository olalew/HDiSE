...
public class InvalidateDockerContainerInfoPropagationService implements IPropagationService {
    @Override
    public void propagate(String json, UUID deviceId) throws Exception {
        ...
        Request request = new Request.Builder()
                .url("http://localhost:8080/api/dockerContainers/status/batch/" + deviceId)
                .put(body)
                .build();
