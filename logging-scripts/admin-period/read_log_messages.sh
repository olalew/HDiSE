...
if [[ -f "$timestamp_file" ]]; then
    ...
    output=$(journalctl --since "$saved_timestamp" -n 100 -o json-pretty)
else
...
java -jar /home/sudokit/Documents/College/Engineering/S6/HDiSE/HDiSE/Worker/worker.jar 4 "$output" >> log.txt
